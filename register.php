        ...
        <div class="col-lg-6 col-md-8 col-sm-10 col-10 border-dark rounded-4 bg-white shadow-lg">
            ...
            <form action="" method="post">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" id="fname" name="fname" class="form-control" placeholder="John" aria-label="First name">
                            </div>
                            <div class="col">
                                <label for="lname" class="form-label">Last Name</label>
                                <input type="text" name="Lname" class="form-control" placeholder="Doe" aria-label="Last name">
                            </div>
                            </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="align-items-center">
                    <p class="text-center mt-3"> Already Have An Account? <a href="Log-In.html">Log In</a> </p>
                </div>
