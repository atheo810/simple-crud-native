<div class="container">
    <div class="jumbotron mt-4 bg-light">
        ...
        <p class="lead">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae, cupiditate tempora incidunt ratione delectus minus. Porro, excepturi aperiam.</p>
        <hr class="my-4">
